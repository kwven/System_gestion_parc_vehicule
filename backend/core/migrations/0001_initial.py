    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_permis', models.CharField(blank=True, choices=[('A', 'A'), ('A1', 'A1'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E')], max_length=10, null=True, validators=[core.models.validate_non_empty_trimmed], verbose_name='Type de permis')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destination', models.CharField(max_length=100, validators=[core.models.validate_non_empty_trimmed], verbose_name='Destination')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('nom', models.CharField(max_length=100, unique=True, validators=[core.models.validate_non_empty_trimmed], verbose_name="Nom de l'entité")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('nom', models.CharField(max_length=100, validators=[core.models.validate_non_empty_trimmed], verbose_name='Nom de la localité')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('nom', models.CharField(max_length=100, validators=[core.models.validate_non_empty_trimmed], verbose_name='Nom de la province')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('nom', models.CharField(max_length=100, unique=True, validators=[core.models.validate_non_empty_trimmed], verbose_name='Nom de la région')),
            ],
            options={
                'verbose_name': 'Région',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('nom', models.CharField(max_length=100, unique=True, validators=[core.models.validate_non_empty_trimmed], verbose_name='Nom du type de coût')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('immatriculation', models.CharField(max_length=50, unique=True, validators=[core.models.validate_non_empty_trimmed], verbose_name='Immatriculation')),
                ...
                ('kilometrage', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Kilométrage')),
                ('date_creation', models.DateField(default=django.utils.timezone.now, verbose_name='Date de création')),
                ('date_modification', models.DateField(default=django.utils.timezone.now, verbose_name='Date de dernière modification')),
                ('est_actif', models.BooleanField(default=True, verbose_name='Est actif')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kilometres_parcourus', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Kilomètres parcourus')),
