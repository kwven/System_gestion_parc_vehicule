...
from .serializers import RegionSerializer, ProvinceSerializer, LocaliteSerializer, EntiteSerializer, ParcSerializer, VehiculeSerializer, TypeCoutSerializer, CoutVehiculeSerializer, DeplacementSerializer, UtilisationVehiculeSerializer, ResponsableParcSerializer, ChefParcParcSerializer, VehiculeParcSerializer, EntiteParcSerializer, DeplacementAgentSerializer, DeplacementChauffeurSerializer, ResponsableSerializer, ChauffeurSerializer, ChefParcSerializer
...
class VehiculeParcViewSet(viewsets.ModelViewSet):
    queryset = VehiculeParc.objects.all()
    serializer_class = VehiculeParcSerializer
