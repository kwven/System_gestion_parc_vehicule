    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matricule', models.CharField(max_length=50, unique=True, validators=[django.core.validators.RegexValidator(message='Le matricule doit contenir uniquement des lettres, des chiffres et des underscores.', regex='^[A-Za-z0-9_]+$')], verbose_name='Matricule')),
