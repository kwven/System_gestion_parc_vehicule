...
import { Calendar, MapPin, Users, User, ChevronLeft, ChevronRight, Eye, Car } from 'lucide-react';
      ...
      <div className="p-1">
        ...
        {!selectedParc ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">Veuillez sélectionner un parc pour voir les véhicules</p>
          </div>
        ) : (
        <>
        {/* Statistiques */}
